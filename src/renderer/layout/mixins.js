...
export const elevation1 = ({ theme }) => theme.newTheme.elevations[0]
export const elevation2 = ({ theme }) => theme.newTheme.elevations[1]

export const backgroundBlur2 = ({ theme }) => theme.newTheme.effects.backgrounBlur[1]
